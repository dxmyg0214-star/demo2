...
（2）相应的设计一个个实验
线性：
![线性实验界面](screenshots/LinearActivityscreenshots.png)


表格：
![表格实验界面界面](screenshots/TableActivityscreenshots.png)


约束性实验1：
![约束性实验1界面](screenshots/Constraint1Activityscreen shots.png)


约束性实验2：
![应用主界面](screenshots/Constraint2Activityscreenshots.png)
